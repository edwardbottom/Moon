...
![image1](Moon/assets/img/minheap1.png){:class="img-responsive"}
...
![image2](Moon/assets/img/minheap2.png){:class="img-responsive"}
...
position. An example of inserting 100 into out min heap is shown below. 
 ...
 ![image3](assets/img/minheap3.png){:class="img-responsive"}
...
![image4](assets/img/minheap4.png){:class="img-responsive"}

It is then swapped with 20. 

![image5](assets/img/minheap5.png){:class="img-responsive"}
...
![image6](assets/img/minheap6.png){:class="img-responsive"}
...
![image7](assets/img/minheap7.png){:class="img-responsive"}
